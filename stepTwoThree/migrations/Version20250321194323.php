 ...
 */
final class Version20250321194323 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fleet (id INT AUTO_INCREMENT NOT NULL, fleet_id VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vehicle (id INT AUTO_INCREMENT NOT NULL, location_id INT DEFAULT NULL, fleet_id INT DEFAULT NULL, license_plate VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_1B80E48664D218E (location_id), INDEX IDX_1B80E4864B061DF9 (fleet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
